...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
   ...
   <div class="container">
          <div class="jumbotron">
            <h1>Coupon applied succesfully!</h1>
            <p>Enjoy the benefits and order more to avail more offers.Thank You,Visit Again.</p>
          </div>
        </div>
      <br>
    ...
    <div class="wide">
        ...
        <div class="col-xs-2 logo"><img src="images/coupon.jfif"></div>
        <div class="col-xs-5 line"><hr></div>
        <br><!-- <br><!-- <br><!-- <br> --> --> -->
        <br><!-- comment -->
        <br>
